"""creating build from scratch revision

Revision ID: c6671b580174
Revises: 
Create Date: 2023-05-22 23:40:29.159353
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("track_id", sa.Integer(), nullable=False),
        sa.ForeignKeyConstraint(
            ["playlist_id"], ["playlists.playlist_id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["track_id"],
            ["tracks.track_id"],
